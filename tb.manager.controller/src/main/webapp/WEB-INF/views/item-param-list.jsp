...
<table class="easyui-datagrid" id="itemParamList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/ow/item/param/queryItemParamList',method:'get',pageSize:30,toolbar:itemParamListToolbar">
    <thead>
        <tr>
...
<script type="text/javascript" src="/js/manager/item-param-list/item-param-list.js"></script>