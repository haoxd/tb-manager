package com.tb.manager.controller.upload;
...
import com.tb.common.bean.PicUploadResult;
import com.tb.manager.service.env.EnvConfigService;
...
public class PicUploadController {
	 ...
	 * 获取配置文件service
	 */
	@Resource(name = "envConfigService")
	...
	public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response)
		...
		// 生成图片的绝对引用地址
		String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, envConfigService.REPOSITORY_PATH),
				"\\", "/");
		fileUploadResult.setUrl(envConfigService.IMAGE_BASE_URL + picUrl);
	...
	/**
	 * 更具上传图片的源路径生成新的路径 生成规程以年月日创建文件夹分别存储图片
	 * 
	...
	private String getFilePath(String sourceFileName) {
		// 创建images目录
		String baseFolder = envConfigService.REPOSITORY_PATH + File.separator + "images";
